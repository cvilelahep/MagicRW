...
FD_FHC_NoNeutron_FilePath = "/dune/data/users/cvilela/CAFs/mcc11_v3/FD_FHC_nonswap_NoNeutron.root"
...
samplesOA_FHC = [ DunePRISMSamples.ProtonEdepm20pc( inFilePath = FHC_FilePath,   outFilePath = "/dune/data/users/cvilela/MagicRW/FHC/", chargeSel=+1),
                  DunePRISMSamples.ProtonEdepm20pc_NoNeutron( inFilePath = FHC_FilePath,   outFilePath = "/dune/data/users/cvilela/MagicRW/FHC/", chargeSel=+1)]
...
FD_samplesOA_FHC = [ DunePRISMSamples.ProtonEdepm20pc_FD( inFilePath = FD_FHC_FilePath,   outFilePath = "/dune/data/users/cvilela/MagicRW/FD_FHC/", chargeSel=0),
                     DunePRISMSamples.ProtonEdepm20pc_NoNeutron_FD( inFilePath = FD_FHC_FilePath,   outFilePath = "/dune/data/users/cvilela/MagicRW/FD_FHC/", chargeSel=0) ]
...
samplesOA_RHC = [DunePRISMSamples.ProtonEdepm20pc( inFilePath = RHC_FilePath,   outFilePath = "/dune/data/users/cvilela/MagicRW/RHC/", chargeSel=-1),
                 DunePRISMSamples.ProtonEdepm20pc_NoNeutron( inFilePath = RHC_FilePath,   outFilePath = "/dune/data/users/cvilela/MagicRW/RHC/", chargeSel=-1)]
...
processesPickle.append( Process( target = MagicRWSample.Sample.produceFriendTrees, args = (FD_FHC_NoNeutron_FilePath, samplesOA_FHC[1], samplesOA_RHC[1], False, True) ) )
